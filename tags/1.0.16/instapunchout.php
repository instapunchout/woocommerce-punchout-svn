...
function instapunchout_order_edit_status($order_id, $new_status)
{
    instapunchout_order_status_changed($order_id, 'edit_status', $new_status);
}
function instapunchout_update_order($order_id)
{
...
add_action('woocommerce_order_edit_status', 'instapunchout_order_edit_status', 10, 2);
add_action('woocommerce_update_order', 'instapunchout_update_order', 10, 1);
